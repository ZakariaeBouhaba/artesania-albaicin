...
const I18N: Record<Lang, Record<string, string>> = {
  es: {
    ...
    visit_p: "Un espacio artesanal en una de las calles más emblemáticas de Granada, a pasos de Plaza Nueva y la Catedral. Diez universos de artesanía andalusí bajo un mismo techo.",
    visit_addr: "Dirección", visit_addr_v: "Calle Calderería Nueva\n18010 Albaycín, Granada",
    visit_hours: "Horario", visit_hours_v: "Lunes a domingo\n9:30 — 00:00",
    ...
    footer_c_alandalus: "Colección Al-Ándalus", footer_c_bereber: "Atlas Bereber",
    footer_c_perfumeria: "Perfumería Árabe", footer_c_ceramica: "Cerámica Zellige",
    ...
    footer_legal: "© 2026 Artesanía Albaycín · Bazar de Granada desde 1987",
    footer_terms: "Términos", footer_privacy: "Privacidad", footer_legal_notice: "Aviso legal",
    cols_eyebrow: "El Bazar", cols_title: "Colecciones\nde la temporada", cols_cta: "Ver todas las colecciones",
  },
  en: {
    ...
    visit_eyebrow: "Visit us in Granada", visit_title: "The boutique\nat the heart of the Albaycín",
    visit_p: "An artisan space on one of Granada's most iconic streets, steps from Plaza Nueva and the Cathedral. Ten worlds of Andalusian craft under one roof.",
    visit_addr: "Address", visit_addr_v: "Calle Calderería Nueva\n18010 Albaycín, Granada",
    visit_hours: "Hours", visit_hours_v: "Monday to Sunday\n9:30 — 00:00",
    ...
    footer_c_alandalus: "Al-Andalus Collection", footer_c_bereber: "Berber Atlas",
    footer_c_perfumeria: "Arabian Perfumery", footer_c_ceramica: "Zellige Ceramics",
    ...
    footer_legal: "© 2026 Artesanía Albaycín · Granada Bazaar since 1987",
    footer_terms: "Terms", footer_privacy: "Privacy", footer_legal_notice: "Legal notice",
    cols_eyebrow: "The Bazaar", cols_title: "Collections\nof the season", cols_cta: "View all collections",
  },
}
